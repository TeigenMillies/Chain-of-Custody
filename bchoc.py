...
import uuid
import datetime
from blockchain import Blockchain, OWNERS_PW  # additional package to be imported
...
# Initialize blockchain if not started
...
# add new evidence item to blockchain, NEEDS crreator password and unique evidence ids
def handle_add(args):
    ...
    # case uuid to hex without dashes
    try:
...
def handle_show_cases(args):
    bc = Blockchain(CHAIN_FILE)
    # loop through and print all cid
...
# display full hisotry of state changes 
